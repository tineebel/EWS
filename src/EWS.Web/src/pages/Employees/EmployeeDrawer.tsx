...
export default function EmployeeDrawer({ employeeCode, onClose }: Props) {
  ...
  const columns: ColumnsType<PositionAssignmentDetail> = [
    ...
    { title: 'Section', key: 'section', width: columnWidth * 5.5, ellipsis: true, render: (_: unknown, record) => formatShortCodeName(record.sectionShortCode, record.sectionCode, record.sectionName) },
    {
      title: 'Start Date',
      dataIndex: 'startDate',
      key: 'startDate',
